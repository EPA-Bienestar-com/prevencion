...
export function HomePage(): JSX.Element {
  ...
  return (
    <div>
      <Header />
      <div className="flex justify-center bg-yellow-100 py-4 px-6 text-sm text-neutral-600">
        <span>
          Novedades:{' '}
          <a href="https://www.epa-bienestar.com/#blog_section" className="font-medium text-yellow-600">
          ...
          <div className="py-20">
            <div className="flex flex-col items-start md:w-128 lg:w-156">
              <p className="max-w-xs text-1xl sm:text-2xl md:max-w-none md:text-3xl lg:text-4xl">
                Hola <span className="text-yellow-600">{profileName}</span></p>
      ...
      <div className="flex w-full justify-center bg-yellow-900 py-4 px-2 sm:px-4 lg:px-8">
        ...
        <section className="mx-auto max-w-7xl px-2 pb-10 sm:px-4 md:pt-6 md:pb-20 lg:px-8">
          ...
          <div className="relative mt-10 flex w-full flex-col items-center justify-center rounded-md bg-white shadow md:flex-row md:justify-start">
            ...
            <div className="flex w-full max-w-[626px] flex-none flex-col items-center justify-center p-4 md:items-start md:justify-start">
              <div className="rounded bg-yellow-100 py-1 px-3">
                <h3 className="text-base font-medium uppercase text-yellow-600">Now available</h3>
              </div>
