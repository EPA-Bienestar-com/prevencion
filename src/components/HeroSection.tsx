...
import WorkingEnvironmentImage from '../img/landingPage/auto_monitoreo_presion_arterial.jpg';
import DoctorImage from '../img/landingPage/consulta_medica.png';
...
export function HeroSection(): JSX.Element {
  return (
    <div className="relative bg-gradient-radial from-yellow-50">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex items-center justify-between space-x-6 py-6 lg:space-x-10">
                  ...
                  <>
                    <Popover.Button
                      className={classNames(
                        ...
                        'group inline-flex items-center rounded-md bg-white text-base font-normal hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2'
                      )}
                    >
                      <span>Servicios</span>
                      <ChevronDownIcon
            ...
            <div className="hidden items-center justify-end md:flex">
              ...
              <Button label="Registro" url="/register" />
            </div>
          </div>
        </div>
            ...
            <div className="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
              ...
              <div className="space-y-6 py-6 px-5">
                ...
                <div>
                  <Link
                    to="/register"
                    className="flex w-full items-center justify-center rounded-md border border-transparent bg-yellow-600 px-4 py-2 text-base font-normal text-white shadow-sm hover:bg-yellow-700"
                  >
                    Registro
                  </Link>
                  <p className="mt-6 text-center text-base font-normal text-gray-500">
                    Existing customer?
                    <Link to="/signin" className="ml-6 text-yellow-600 hover:text-yellow-500">
                      Login
                    </Link>
                  </p>
                </div>
        ...
        <div className="flex w-full flex-col items-center pt-8 pb-8 text-left sm:items-start sm:pb-36 md:py-36">
          <div className="flex flex-col items-center sm:items-start">
            <h1 className="text-center text-3xl font-medium tracking-wider text-gray-900 sm:text-left sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl">
              ...
              <p className="text-yellow-600">Con Expertos</p>
            </h1>
            <p className="mt-6 w-full max-w-xs text-lg font-normal text-neutral-600 sm:max-w-none md:max-w-sm lg:max-w-lg lg:text-xl">
              "Conoce y Controla tu Presión Arterial"{' '}
            </p>
            <div className="mt-8 sm:flex sm:justify-center md:mt-20 lg:justify-start">
              <div className="rounded-md shadow">
                <a
                  href="/register"
                  className="flex w-full items-center justify-center rounded-md border border-transparent bg-yellow-600 py-4 px-20 text-lg font-normal text-white hover:bg-yellow-700"
                >
                  Comenzar!
                </a>Enlance a Registro de nuevos usuarios
              </div>
            </div>
          </div>
          <img
